...
const PRESETS: { id: ToolPreset; label: string; desc: string; tools: string[] }[] = [
  { id: "none",    label: "关闭",  desc: "不使用工具",                                tools: PRESET_NONE },
  { id: "default", label: "默认",  desc: "read、bash、edit、write",              tools: PRESET_DEFAULT },
  { id: "full",    label: "全部", desc: "read、bash、edit、write、grep、find、ls", tools: PRESET_FULL },
];
  ...
  return (
    ...
    >
      ...
      <div style={{ fontSize: 11, color: "var(--text-dim)", lineHeight: 1.5 }}>
        ...
        {current === "none" && <span>，Agent 不会使用任何工具</span>}
      </div>
