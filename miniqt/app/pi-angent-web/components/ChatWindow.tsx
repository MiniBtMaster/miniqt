...
export function ChatWindow({ session, newSessionCwd, onAgentEnd, onSessionCreated, onSessionForked, onFilesChanged, onBashPythonFile, modelsRefreshKey, chatInputRef, onBranchDataChange, onSystemPromptChange, onSessionStatsChange, onContextUsageChange }: Props) {
  const {
          ...
          <div className="w-full max-w-[820px]">
            ...
            >
              <div style={{ display: "flex", alignItems: "baseline", gap: 10, minWidth: 0, flex: 1, lineHeight: 1.4 }}>
                <span style={{ fontSize: 22, color: "var(--text)", fontWeight: 700, letterSpacing: "-0.01em" }}>Pi Agent</span>
